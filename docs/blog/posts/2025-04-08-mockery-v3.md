...
So all of these examples show around half a second to parse a _single_ interface, and you can imagine if you have a project with dozens, even hundreds of interfaces, you're looking at a runtime of over... (consults calculator)... somewhere in the ballpark of 20 seconds to even over 100 seconds. That's crazy! Why does anyone subject themselves to this torture? How long must I stare at my GitHub CICD checks to display those sweet little green checkmarks we all know and love?
...
I feel like Steve Ballmer when he got up on stage chanting "deVELoper deVELopers DEVELOPERS DEVELOPERS [sigh]... [pant]... DEVELOPERS". Except for me it's more like "TEMplates TEMplates TEMPLATES!"
